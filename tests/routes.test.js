...
describe('Items API', () => {
  it('should show all users', async done => {
    ...
    it('should update a user', async done => {
      const res = await request(app).put(`/api/users/${user}`).send(
        {
          first_name: 'TEST1',
          last_name: 'TEST1',
          email: 'test1@test1.com',
...
//do yarn test on the terminal to see if these tests work
//Check this out
...
// for reference purpose: https://github.com/visionmedia/supertest#readme